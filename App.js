...
import ListaD from './src/telas/ListaD';
import mock_listaM from './src/mocks/listaD';
...
function TabsMenu() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Lista de Desejos" component={MenuF} options={{ tabBarBadge: 3 }} />
